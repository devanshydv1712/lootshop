  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        <a href="https://my-portfolio-d44m.onrender.com" target="_blank" rel="noreferrer" style={socialBtnStyle}>🌐 Website</a>
       
        
        <a href="https://www.linkedin.com/in/devansh-yadav-b1849229a?utm_source=share_via&utm_content=profile" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💼 LinkedIn</a>
